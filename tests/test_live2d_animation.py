...
class TestLive2DAnimation:
    ...
    def test_animate_endpoint_valid_request(self):
        ...
        response = self.client.post('/animate', 
...
class TestAnimationParameterValidation:
    ...
    def test_intensity_bounds(self):
        ...
        response = client.post('/animate', data=json.dumps(data), content_type='application/json')
        assert response.status_code == 400
...
class TestAnimationStateTracking:
    ...
    def test_animation_state_updates(self):
        ...
        self.client.post('/animate', data=json.dumps(data), content_type='application/json')
...
class TestAnimationIntegration:
    ...
    def test_main_page_rendering(self):
        ...
        with patch('src.config.settings.get_settings') as mock_settings:
            ...
            mock_settings.return_value.live2d.model_url = '/static/models/test.model3.json'
    ...
    def test_error_handling(self):
        ...
        # Test invalid JSON
        response = self.client.post('/animate', data='invalid', content_type='application/json')
        assert response.status_code == 400
