...
class EnhancedVoiceAssistant:
    ...
    async def _handle_user_speech(self, user_msg: str, participant: rtc.RemoteParticipant) -> None:
        """
        ...
        try:
            ...
            self.active_users[user_id] = {
                ...
                'message_count': self.active_users.get(user_id, {}).get('message_count', 0) + 1
            }
    ...
    async def say(self, message: str, participant: Optional[rtc.RemoteParticipant] = None) -> None:
        """
