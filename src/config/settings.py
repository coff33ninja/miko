...
class Live2DConfig:
    ...
    model_url: str = "/static/models/Poblanc.model3.json"
...
class ConfigManager:
    ...
    def load_config(self) -> AppConfig:
        ...
        try:
            ...
            content_filter_config = ContentFilterConfig(
                ...
                strict_mode=os.getenv("CONTENT_FILTER_STRICT_MODE", "false").lower() == "true"
            )
            ...
            live2d_config = Live2DConfig(
                model_url=os.getenv("LIVE2D_MODEL_URL", "/static/models/Poblanc.model3.json"),
                textures_url=os.getenv("LIVE2D_TEXTURES_URL", "/static/models/textures/")
            )
    ...
    def _validate_config(self) -> None:
        ...
        if self._config.ai.gemini_api_keys:
            if self._config.ai.gemini_current_key_index >= len(self._config.ai.gemini_api_keys):
                self.logger.warning(
        ...
        if self._config.memory.mem0_api_key and self._config.memory.memory_history_limit <= 0:
